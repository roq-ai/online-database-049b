...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['document-manager', 'administrator', 'search-user', 'guest-user', 'it-support'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Email Logs', path: '/email-logs', entity: 'email_logs', service: AccessServiceEnum.PROJECT, icon: FiMail },
    {
      name: 'It Supports',
      path: '/it-supports',
      entity: 'it_support',
