...
import { useDocumentFindFirst, useRoqClient } from 'lib/roq';
...
function DocumentViewPage() {
  ...
  const { data, error, isLoading } = useDocumentFindFirst(queryParams, {}, { disabled: !id });
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Document Type" text={data?.document_type} />
