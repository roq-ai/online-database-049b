  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Online Database - Streamlining your document management process by storing scanned documents on a secure server and making them effortlessly searchable."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1562654501-a0ccc0fc3fb1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkb2N1bWVudHxlbnwwfHx8fDE2OTc0NjU5NjZ8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Online Database - Streamlining your document management process by storing scanned documents on a secure server and making them effortlessly searchable.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Document Manager" type="document-manager" abilities={appConfig.ownerAbilities} />
