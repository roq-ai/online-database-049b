...
import { useRoqClient, useSearchFindManyWithCount } from 'lib/roq';
...
export function SearchListPage(props: SearchListPageProps) {
      ...
      convertQueryToPrismaUtil(
        {
          ...
          searchTermKeys: ['query.contains', 'results.contains'],
          ...params.filters,
        },
        'search',
      ),
  ...
  const { data, error, isLoading, mutate } = useSearchFindManyWithCount({
  ...
  const handleDelete = async (id: string) => {
    setDeleteError(null);
    try {
      await roqClient.search.delete({ where: { id } });
      await mutate();
    } catch (error) {
